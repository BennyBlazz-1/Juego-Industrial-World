...
@export var always_show_exclamation: bool = true
...
func update_visual_state() -> void:
	var available: bool = can_open_station()
	...
	exclamation_mark.visible = available and always_show_exclamation
...
func _on_dialogue_ended(_dialogue) -> void:
	...
	if opened_here:
		...
		if not repeatable and step_name != "":
